...
# Use python 3.6
BuildRequires: python36 python3-rpm-macros
# Use boost 1.5.7
...
install -m 644 %{_sourcedir}/kea-logrotate %{buildroot}%{_sysconfdir}/logrotate.d/kea
...
* Fri Jun 29 2018 Rasmus Edgar <regj@arch-ed.dk> - 1.4.0-2
- Add kea-shell and kea-logrotate.conf

* Fri Jun 15 2018 Rasmus Edgar <regj@arch-ed.dk> - 1.4.0-1
- Adjusted the kea.spec for kea 1.4.0-1. Change kea systemd scripts to use keactrl for reloading.
